...
router.get('/invoice', isLoggedIn, async function (req, res, next) {
  try {
...
router.post('/add', isLoggedIn, async function (req, res, next) {
  try {
    const { invoice, time, operator, totalsum, supplier, itemcode, qty, purchaseprice, totalprice } = req.body;

    console.log('purchases', req.body)

    // const purchaseitems = await Purchaseitem.create({ invoice, itemcode, qty, purchaseprice, totalprice });
